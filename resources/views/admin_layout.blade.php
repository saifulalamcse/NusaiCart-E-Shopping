...
<body>
			...
			<div id="sidebar-left" class="span2">
				<div class="nav-collapse sidebar-nav">
					<ul class="nav nav-tabs nav-stacked main-menu">
						...
						<li><a href="{{URL::to('/old-products')}}"><i class="icon-font"></i><span class="hidden-tablet"> Old Product</span></a></li>

						<li>
							<a class="dropmenu" href="#"><i class="icon-folder-close-alt"></i><span class="hidden-tablet">Coupons</span></a>
							<ul>
								<li><a href="{{URL::to('/add-coupon')}}"><i class="icon-tasks"></i><span class="hidden-tablet">Add Coupon</span></a></li>

								<li><a class="submenu" href="{{URL::to('/all-coupon')}}"><i class="icon-file-alt"></i><span class="hidden-tablet"> All Coupon</span></a></li>
							</ul>	
						</li>
						...
						<li>
							...
							<ul>
								<li><a href="{{URL::to('/add-man')}}"><i class="icon-tasks"></i><span class="hidden-tablet">Add Delivery Man</span></a></li>

								<li><a class="submenu" href="{{URL::to('/all-deliver')}}"><i class="icon-file-alt"></i><span class="hidden-tablet"> All Delivery Man </span></a></li>
							</ul>	
						</li>
	...
	<footer>
		...
		<p>
			<span style="text-align:left;float:left"><a href="http://bootstrapmaster.com/" alt="Bootstrap Themes"></a></span>
			<span class="hidden-phone" style="text-align:right;float:right"><a href="http://admintemplates.co/" alt="Bootstrap Admin Templates"></a></span>
		</p>
	...
	<!-- start: JavaScript-->
		...
		<script src=asset"{backend/{asset('backend/js/counter.js')}}"></script>
