			...
			<div class="row-fluid sortable">
				<div class="box span12">
					...
					<div class="box-content">
						<form class="form-horizontal" action="{{ url('/update-brand',$all_brand_info->id) }}" method="post">
							{{ csrf_field() }}
						  <fieldset>
							...
							<div class="control-group hidden-phone">
							  ...
							  <div class="controls">
								<textarea class="cleditor" name="brand_description" rows="3">{{$all_brand_info->brand_description}}	
								</textarea>
							  </div>
							</div>
