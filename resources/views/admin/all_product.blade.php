			...
			<div class="row-fluid sortable">		
				<div class="box span12">
					<div class="box-header" data-original-title>
						<h2><i class="halflings-icon product"></i><span class="break"></span>Members</h2>
					...
					<div class="box-content">
						<table class="table table-striped table-bordered bootstrap-datatable datatable">
						  ...
						  <tbody>
                          @foreach($all_prod_info as $v_product)  
							 <tr>
								<td>{{$v_product->product_id}}</td>
								<td class="center">{{$v_product->product_name}}</td>
								<td class="center">{{$v_product->qty}}</td>
								...
								<td class="center">{{$v_product->Brand->brand_name ?? ''}}</td>
								...
								<td class="center">
									...
									href="{{URL::to('/delete-product/'.$v_product->product_id)}}" onclick="return confirm('Are you sure');">
